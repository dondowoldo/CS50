...
// Make sure no value exceeds 255 as max amount of bits in a byte.
void sepia(int height, int width, RGBTRIPLE image[height][width])
{
    ...
    for (int i = 0, n = height; i < n; i++) // Looping while applying Sepia filter to current pixel as in the sepia formula above.
    {
        for (int j = 0, m = width; j < m; j++)
        {
